...
% par 06
semilogx(tStar_swpRateP,eTXrate_pRate03_06d(:,1)/e0_frx,'.r','LineWidth',3)
semilogx(tStar_swpRateP,eTXrate_pRate03_06d(:,2)/e0_frx,'.b','LineWidth',3)
semilogx(tStar_swpRateP,eTXrate_pRate03_06d(:,3)/e0_frx,'.g','LineWidth',3)
semilogx(tStar_swpRateP,eTXrate_pRate03_06d(:,4)/e0_frx,'.m','LineWidth',3)
semilogx(tStar_swpRateP,eTXrate_pRate03_06d(:,5)/e0_frx,'.c','LineWidth',3)
semilogx(tStar_swpRateP,eTXrate_pRate03_06d(:,6)/e0_frx,'.y','LineWidth',3)
semilogx(tStar_swpRateP,eTXrate_pRate03_06d(:,8)/e0_frx,'.k','LineWidth',3);hold off;grid on;
pbaspect([1 1 1])
% xlim([5E-7,3E-4])
xlabel('t*','FontSize',15)
ylabel('Dimensionless Tilt','FontSize',15)
